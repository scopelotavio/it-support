...
**<u>Guillermo Gonzalez Camarena</u>**
...
![NOT gate schema and truth table](public/01_NOT-Gate.png)
...
![AND gate schema and truth table](public/02_AND-Gate.png)
...
![OR gate schema and truth table](public/03_OR-Gate.png)
...
![XOR gate schema and truth table](public/04_XOR-Gate.png)
...
![NAND gate schema and truth table](public/05_NAND-Gate.png)
...
![XNOR gate schema and truth table](public/06_XNOR-Gate.png)
...
![Combined circuit schematic](public/07_Circuit-drawing.png)

Here is the truth table for this circuit:

![Combined circuit truth table](public/08_Circuit-Truth-table.png)
...
| | 1<sup>st</sup> bit | 2<sup>nd</sup> bit | 3<sup>rd</sup> bit | 4<sup>th</sup> bit | 5<sup>th</sup> bit | 6<sup>th</sup> bit | 7<sup>th</sup> bit | 8<sup>th</sup> bit |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
